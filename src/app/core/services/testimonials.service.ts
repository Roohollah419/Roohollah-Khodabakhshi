...
import { Testimonial, TestimonialsContent } from '../models/testimonials.models';
...
export class TestimonialsService {
  ...
  /**
   * Fetches Testimonials content data (heading and subheading)
   * @returns TestimonialsContent object
   */
  fetchTestimonialsContent(): TestimonialsContent {
    return {
  ...
  /**
   * Fetches carousel configuration options for testimonials display
