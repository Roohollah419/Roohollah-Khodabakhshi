...
import { Technology, TechnologyCategory, WorkExperience, WorksContent } from '../models/works.models';
...
export class WorksService {
  ...
  /**
   * Fetches Works content data (heading and subheading)
   * @returns WorksContent object
   */
  fetchWorksContent(): WorksContent {
    return {
  ...
  /**
   * Fetches all work experience data
   * @returns Array of WorkExperience objects sorted by order
   */
  fetchWorkExperiences(): WorkExperience[] {
    return [
      {
  ...
  /**
   * Fetches carousel configuration options for work experience display
  ...
  /**
   * Helper method to extract and map technology names to Technology objects
   * @param techNames Array of technology name strings
   * @returns Array of Technology objects with category, color, and icon
   */
